...
import 'package:app_pcp/features/flyer/widgets/face/face_2.dart';
...
void main() {
  testGoldens('test flyer 2 default values', (WidgetTester tester) async {
    ...
    await tester.runAsync(() async {
      ...
      final widget = SizedBox(
        width: 250,
        height: 500,
        child: Face2(state: faceBloc.state),
      );
    ...
    await screenMatchesGolden(tester, 'flyer_2');
  });
  ...
  testGoldens('test flyer 2 max length title 15', (WidgetTester tester) async {
    ...
    await screenMatchesGolden(tester, 'flyer_2_15_length');
  });
}
