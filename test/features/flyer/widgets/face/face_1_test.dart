...
import 'package:app_pcp/features/flyer/widgets/face/face_1.dart';
...
void main() {
  testGoldens('test flyer 1 default values', (WidgetTester tester) async {
    ...
    await tester.runAsync(() async {
      ...
      final widget = SizedBox(
        width: 250,
        height: 500,
        child: Face1(state: faceBloc.state),
      );
    ...
    await screenMatchesGolden(tester, 'flyer_1');
  });
  ...
  testGoldens('test flyer 2 max length title 15', (WidgetTester tester) async {
    ...
    await screenMatchesGolden(tester, 'flyer_1_15_length');
  });
}
